...
import pageclasses.IdentityPage;
import pageclasses.LoginPage;
import pageclasses.MyAccountPage;
import pageclasses.MypersonalInformationPage;
...
//Here updating password and clicking on save
		...
		perinfopage.validateChangePassword("test1281", "test1282", "test1282");
...
//Relogin again with changed Password and Assertion of page Title
		...
		logpage.doLogin("reachautotest1281@gmail.com", "test1282");
		acctpage = new MyAccountPage(driver);
