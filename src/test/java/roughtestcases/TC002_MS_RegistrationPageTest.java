...
//Clicking on Create an account will happen inside the method itself.
		...
		logpage.setNewUserEmailAddress("reachautotest4000@gmail.com");
		test.log(LogStatus.INFO, "Clicked on Created a new account in Login Page");

		regpage = new RegisterPage(driver);
		regpage.validateRegister("Adam", "Marth", "test4000", "Adam", "Marth", "4000 HomeWood", "Moline", 
				"13", "61276","21", "6475645022", "4000 SpringValley");
		Thread.sleep(1000);
