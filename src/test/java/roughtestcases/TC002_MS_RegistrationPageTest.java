...
//Clicking on Create an account will happen inside the method itself.
		...
		logpage.setNewUserEmailAddress("reachautotest1306@gmail.com");
		test.log(LogStatus.INFO, "Clicked on Created a new account in Login Page");

		regpage = new RegisterPage(driver);
		regpage.validateRegister("James", "Oliver", "test1306", "James", "Oliver", "1306 HomeWood", "Moline", 
				"13", "61275","21", "6475645022", "1306 SpringValley");
		Thread.sleep(1000);
